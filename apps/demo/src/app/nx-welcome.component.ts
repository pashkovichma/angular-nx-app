    ...
    <div class="wrapper">
      <div class="container">
            ...
            <h2>
              ...
              >
                <path
                  ...
                  i18n-stroke-linejoin
                  stroke-width="2"
                  d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"
                  i18n-d
                />
              </svg>
              <span i18n>You&apos;re up and running</span>
            </h2>
            <a i18n href="#commands"> What&apos;s next? </a>
          </div>
          ...
          <div id="middle-left-content">
            <div id="learning-materials" class="rounded shadow">
              ...
              >
                ...
                <span>
                  Documentation
                  <span i18n> Everything is in there </span>
                </span>
                <svg
                  fill="none"
                  stroke="currentColor"
              ...
              >
                ...
                <span>
                  Blog
                  <span i18n> Changelog, features & events </span>
                </span>
                <svg
                  fill="none"
                  stroke="currentColor"
              ...
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <title>YouT i18n i18n i18n i18n i18n i18n i18n i18n i18n i18nube</title>
                  <path
                ...
                <span>
                  YouTube channel
                  <span i18n> Nx Show, talks & tutorials </span>
                </span>
                <svg
                  fill="none"
                  stroke="currentColor"
              ...
              >
                ...
                <span>
                  ...
                  <span i18n> Create an app, step-by-step </span>
                </span>
                <svg
                  fill="none"
                  stroke="currentColor"
            ...
            >
              ...
              <span>
                Nx is open source
                <span i18n> Love Nx? Give us a star! </span>
              </span>
            </a>
          </div>
          <div id="other-links">
            ...
            >
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <title>Visu i18n i18n i18n i18n i18n i18n i18n i18n i18n i18nal Studio Code</title>
                <path
              ...
              <span>
                ...
                <span i18n>The official VSCode extension for Nx.</span>
              </span>
            </a>
            <a
            ...
            >
              <svg height="48" width="48" viewBox="20 20 60 60" xmlns="http://www.w3.org/2000/svg">
                <path d="m22.5 22.5h60v60h-60z" i18n-d />
                <g fill="#fff">
                  <path d="m29.03 71.25h22.5v3.75h-22.5z" i18n-d />
                  <path
                    ...
                    i18n-d
                  />
                  <path d="m36 30h7.53v2.19h-5v1.44h4.49v2h-4.42v1.49h5v2.21h-7.6z" i18n-d />
                  <path d="m47.23 32.29h-2.8v-2.29h8.21v2.27h-2.81v7.1h-2.6z" i18n-d />
                  <path
                  ...
                  <path
                    ...
                    i18n-d
                  />
                  <path d="m56.46 43.05h2.6v9.37h-2.6z" i18n-d />
                  <path
              ...
              <span>
                ...
                <span i18n>Available for WebStorm, Intellij IDEA Ultimate and more!</span>
              </span>
            </a>
            <div id="nx-cloud" class="rounded shadow">
              <div>
                ...
                <h2>
                  Nx Cloud
                  <span i18n> Enable faster CI & better DX </span>
                </h2>
              </div>
              <p i18n>You can activate distributed tasks executions and caching by running:</p>
              <pre i18n>nx connect</pre>
              <a
                i18n
        ...
        <div id="commands" class="rounded shadow">
          <h2 i18n>Next steps</h2>
          <p i18n>Here are some things you can do with Nx:</p>
          <details>
            <summary>
              <svg
                fill="none"
            ...
            <pre><span i18n># Build</span>
nx build 
<span i18n># Test</span>
nx test 
<span i18n># Lint</span>
nx lint 
<span i18n># Run them together!</span>
nx run-many -t build test lint</pre>
          ...
          <details>
            ...
            <pre i18n>nx show project demo</pre>
          </details>
          ...
          <details>
            ...
            <pre><span i18n># Generate UI lib</span>
nx g &#64;nx/angular:lib ui
<span i18n># Add a component</span>
